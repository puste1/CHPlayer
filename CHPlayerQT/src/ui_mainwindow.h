...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon1(QIcon::fromTheme(QString::fromUtf8("video-x-generic")));
        ...
        QIcon icon2(QIcon::fromTheme(QString::fromUtf8("audio-card")));
        ...
        QIcon icon3(QIcon::fromTheme(QString::fromUtf8("view-fullscreen")));
